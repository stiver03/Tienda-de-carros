...
public class MenuNuevoAutomovil extends javax.swing.JFrame {
    ...
    private String[][] movilCategoria=new String[100][100];
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        cantidadAutos++;
        ControlAutomovil auto= ControlAutomovil.getInstance();
        ControlCategoria catego= ControlCategoria.getInstance();
        ...
        {
           if((cantidadAutos==1) || (!movilCategoria[0][i-1].equals(categoria)))
           {
               movilCategoria[0][i]=categoria;
               movilCategoria[1][i]=String.valueOf(cantidadAutos);
           }
        }
